...
the **areaOfEffect** project!

This document provides guidelines for contributing to areaOfEffect—its
...
areaOfEffect is an R package that depends on the `sf` package for
spatial operations.
...
areaOfEffect uses **testthat** for testing. All tests are located in
`tests/testthat/`.
...
By contributing to areaOfEffect, you agree that your code is released
